...
def compress_photo():
    '''调用压缩图片的函数
    '''
    src_dir, des_dir = "photos_tmp/", "min_photos_tmp/"
...
def handle_photo():
    ...
    with open("/home/swyoung/Documents/Blog/source/photos/data.json","w") as fp:
...
def move_photo():
    os.system('mv photos_tmp/* photos/')
    os.system('mv min_photos_tmp/* min_photos/')
